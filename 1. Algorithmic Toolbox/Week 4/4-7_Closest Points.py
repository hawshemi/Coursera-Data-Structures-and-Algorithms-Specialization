...
# min distance of left_points # called min_left &
# min distance of right_points called min_right &
# min distance between left_points and right_points called hybrid_min.
